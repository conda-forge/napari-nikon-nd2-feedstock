About napari-nikon-nd2-feedstock
================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-nikon-nd2-feedstock/blob/main/LICENSE.txt)
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/napari-nikon-nd2-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/napari-nikon-nd2-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-nikon-nd2` can be installed with `conda`:
...
```
mamba install napari-nikon-nd2
```

It is possible to list all of the versions of `napari-nikon-nd2` available on your platform with `conda`:
...
```
mamba search napari-nikon-nd2 --channel conda-forge
```
...
mamba repoquery search napari-nikon-nd2 --channel conda-forge

# List packages depending on `napari-nikon-nd2`:
mamba repoquery whoneeds napari-nikon-nd2 --channel conda-forge

# List dependencies of `napari-nikon-nd2`:
mamba repoquery depends napari-nikon-nd2 --channel conda-forge
```
